        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>TRACER STUDY !</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Isi Kuisioner <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                     
                      <li><a href="isi.php">Isi kuisioner</a></li>
                  ...
                  <li><a><i class="fa fa-table"></i> E-career<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="lowonganadmin.php">Lowongan perkerjaan</a></li>
                      <li><a href="datapekerjaanadmin.php">Data pekerja</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-bar-chart-o"></i> Grafik<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="grafikutamaalumni.php">Grafik utama</a></li>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
					     ...
					     <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Tahun lulus <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="birthday" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                        </div>
                  ...
                  <form class="form-horizontal form-label-left">
                    <div class="form-group">
                      <label>Apakah materi perkuliahan dapat diimplementasikan di tempat kerja?</label>
                       <p>
                        Ya:<input type="radio" class="flat" name="gender" id="genderM" value="M" checked="" required /> 
						Tidak:<input type="radio" class="flat" name="gender" id="genderF" value="F" />
						Sebagian:<input type="radio" class="flat" name="gender" id="genderM" value="M" checked="" required />
						Tidak tahu:<input type="radio" class="flat" name="gender" id="genderM" value="M" checked="" required /> 
						</p>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      <label>Apakah nilai IPK dan mata kuliah berpengaruh dalam mencari pekerjaan?</label>
                       <p>
                        Sangat:<input type="radio" class="flat" name="gender" id="genderM" value="M" checked="" required /> 
						Biasa saja:<input type="radio" class="flat" name="gender" id="genderF" value="F" />
						Tidak berpengaruh:<input type="radio" class="flat" name="gender" id="genderM" value="M" checked="" required />
						Tidak tahu:<input type="radio" class="flat" name="gender" id="genderM" value="M" checked="" required /> 
						</p>
                    </div>
					<div class="form-group">
