                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Isi Kuisioner <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                     ...
                     <li><a href="pengalaman.php">Pengalaman kerja</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-table"></i> E-career<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="lowonganalumni.php">Lowongan perkerjaan</a></li>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Batas waktu <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Alamat perusahaan</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
